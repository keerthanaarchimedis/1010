 ...
 @WebServlet(urlPatterns="/fetch")
   ...
   //Gathering the Result set from Ds
      ResultSet rs = stmt.executeQuery(sql);
        ...
        out.println("<tr><th>Name</th><th>Roll_No</th><th>Qualification</th><th>City</th><th>Age</th><tr>");
     // Extract data from result set
        ...
        out.println("<tr><td>" + name + "</td><td>" + roll_no + "</td><td>" + qualification + "</td><td>" + city1 + "</td><td>"+age + "</td></tr>");
        }
        out.println("</table>");
